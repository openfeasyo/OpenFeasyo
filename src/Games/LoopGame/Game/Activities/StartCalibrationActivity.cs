...
namespace LoopLib.Activities
{
    public class StartCalibrationActivity : OpenFeasyo.GameTools.UI.Activity
    {
        ...
        public StartCalibrationActivity(UIEngine engine, IEmgSensorInput emgInput) : base(engine)
        {
            ...
            Label infoLabel1 = new Label("Rest your muscles for calibrating sensors,", engine.Content.LoadFont("Fonts/Ubuntu48"), LoopGame.MENU_FONT_COLOR);
            infoLabel1.Position = engine.Screen.ScreenMiddle - infoLabel1.Size / 2 - new Vector2(0, 150);
            Components.Add(infoLabel1);

            Label infoLabel2 = new Label("click on the button the start the calibration", engine.Content.LoadFont("Fonts/Ubuntu48"), LoopGame.MENU_FONT_COLOR);
