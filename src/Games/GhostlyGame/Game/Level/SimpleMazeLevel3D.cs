...
{
    public class SimpleMazeLevel3D : Level3D
    {
        ...
        public override LevelAnalytics Analytics => throw new NotImplementedException();

        #endregion Public members

        public SimpleMazeLevel3D(GameScreen gameScreen, LevelElements elements) : base(gameScreen)
        {
            this._elements = elements;
            this.Character = new MazeCharacter3D(gameScreen, elements, ThreeDEffects.Instance.Character, ThreeDEffects.Instance.CharacterLeftRotating, ThreeDEffects.Instance.CharacterRightRotating, false);
        }
