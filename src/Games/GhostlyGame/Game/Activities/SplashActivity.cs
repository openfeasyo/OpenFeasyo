...
namespace GhostlyLib.Activities
{
    class SplashActivity : OpenFeasyo.GameTools.UI.Activity
    {
        public SplashActivity(UIEngine engine) : base(engine)
        {
            ...
            ghostlyImage.Size = new Vector2((ghostlyImage.Size.X / ghostlyImage.Size.Y) * cell *10, cell*10);
            ...
            vubetrologoImage.Size = new Vector2((vubetrologoImage.Size.X/ vubetrologoImage.Size.Y) * cell*2, cell*2);//vubetrologoImage.Size / 2;
