...
{
    public class MazeSimpleCharacter3D : GameCharacter3D
    {
        ...
        protected float Target_Duration_Left
        {
            get
            {
                ...
                if (GameSessionInfo.Instance.SelectedPatient != null && GameSessionInfo.Instance.SelectedPatient.CurrentDifficultyLevel != null)
                    return DifficultyLevelStateSpace.Instance.getLevelDefinition((int)GameSessionInfo.Instance.SelectedPatient.CurrentDifficultyLevel).contractionDuration / 1000;
        ...
        public MazeSimpleCharacter3D(GameScreen gameScreen, LevelElements elements,
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                // Update View matrix
                _3DCamera.UpdateView(this.OriginalRotation, -0.1f, this.Xi, this.Yi);//_3DCamera.UpdateView(this.OriginalRotation + this.CurrentRotation, -0.1f, this.Xi, this.Yi);
