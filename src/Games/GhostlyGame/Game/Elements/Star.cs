...
namespace GhostlyLib.Elements
{
    public class Star : Drawable
    {
        ...
        public Star(int x, int y, LevelElements elements, Texture2D image, GameScreen gameScreen, double checkpoint) : base(gameScreen)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.Draw(this.Sprite, GameScreen.Screen.ToScreen((int)this.X, (int)this.Y, this._width, this._height), Color.White);
            }
        }
