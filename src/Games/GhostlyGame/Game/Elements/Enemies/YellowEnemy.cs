...
{
    public class YellowEnemy : EasyEnemy
    {
        public override int Height { get { return 77; } }
        public override int Width { get { return 56; } }

        public YellowEnemy(int x, int y, LevelElements elements, EnemyAnimation animation, GameScreen gameScreen, double checkpoint) : base(x, y, elements, gameScreen, checkpoint)
        {
