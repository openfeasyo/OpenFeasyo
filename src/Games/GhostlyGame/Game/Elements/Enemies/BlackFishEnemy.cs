...
{
    public class BlackFishEnemy : EasyEnemy
    {
        public override int Height { get { return 40; } }
        public override int Width { get { return 63; } }

        public BlackFishEnemy(int x, int y, LevelElements elements, EnemyAnimation animation, GameScreen gameScreen, double checkpoint) : base(x, y, elements, gameScreen, checkpoint)
        {
