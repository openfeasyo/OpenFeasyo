...
namespace GhostlyLib.Elements.Enemies
{
    public class BlackEnemy : EasyEnemy
    {
        ...
        public BlackEnemy(int x, int y, LevelElements elements, EnemyAnimation animation, GameScreen gameScreen, double checkpoint) : base(x, y, elements, gameScreen, checkpoint)
        {
