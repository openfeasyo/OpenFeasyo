...
namespace GhostlyLib.Elements.Enemies
{
    public class RedFlyEnemy : MediumEnemy
    {
        ...
        public RedFlyEnemy(int x, int y, LevelElements elements, EnemyAnimation animation, GameScreen gameScreen, double checkpoint) : base(x, y, elements, gameScreen, checkpoint)
        {
